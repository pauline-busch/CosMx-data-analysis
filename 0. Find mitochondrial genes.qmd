...
From the Nanostring website - get the Gene information for [CosMx™ Human 6K Discovery Panel](https://nanostring.com/products/cosmx-spatial-molecular-imager/cosmx-rna-assays/human-6k-discovery-panel/). Genes that contain "mitichon" in their full name or full alias are recognized and will be used to annotate the Genes in our CosMx data. 
...
```{r}
write.csv(gene_matrix_mito, file.path(cos_path, "TMA2_biomedx_MAR_6K_mito_exprMat_file.csv"), row.names = FALSE)
```
